...
public class Game extends GameApplet {
        ...
        for(int l = 0; l < j; l++) {
            ...
            if(updateRequired == 0) {
                ...
                if(k1 == 0) {
                    ...
                    npc.moveInDirection(i2, true);
                    int k2 = buffer.readBits(3);
                    npc.moveInDirection(k2, true);
    ...
    public void registerNewNpcs(boolean flag, Buffer class39_sub3_sub3, int i)
    {
        while(class39_sub3_sub3.bitPosition + 21 < i * 8)
        {
            ...
            if(j == 16383)
                break;
            if(aNpcArray899[j] == null)
                aNpcArray899[j] = new Npc();
            Npc npc = aNpcArray899[j];
            ...
            npc.aNpcConfig_1772 = NpcConfig.getDefinition(class39_sub3_sub3.readBits(13));
            npc.anInt1608 = npc.aNpcConfig_1772.aByte820;
            npc.anInt1609 = npc.aNpcConfig_1772.anInt803;
            npc.anInt1644 = npc.aNpcConfig_1772.anInt813;
            npc.anInt1645 = npc.aNpcConfig_1772.anInt787;
...
label0:
    ...
    public void method30(int i)
    {
        ...
        if(anInt931 > 173)
        {
            ...
            outgoingVector.writeMiddleBE(0x1123f0);
        }
        j = anInt1296 * 128 + 64;
        if(i >= 0)
            currentOpcode = incommingVector.readUByte();
    ...
    public boolean parseOpcode(int i) {
        ...
        try
        {
            ...
            if(opcodeSize == -2)
                if(j > 1)
                {
                    ...
                    opcodeSize = incommingVector.readUShortBE();
                    j -= 2;
                } else
                {
                    return false;
            ...
            {
                needDrawTabArea = true;
                int k = incommingVector.readUShortBE();
                RSInterface class34 = RSInterface.getInterface(k);
                int j16 = incommingVector.readUShortBE();
            ...
            if(currentOpcode == 156)
            {
                ...
                anInt1031 = incommingVector.readUShortBE();
            ...
            if(currentOpcode == 121 || currentOpcode == 30) {
                ...
                {
                    k10 = incommingVector.readUShortLE();
                    i1 = incommingVector.readUShortBE();
                    aBoolean1102 = false;
                }
                if(currentOpcode == 30)
                {
                    ...
                    k10 = incommingVector.readUShortBE();
                    i1 = incommingVector.readUShortLE();
                    aBoolean1102 = true;
                }
		...
		System.out.println("k1: " + k1 + ", i11: " + i11);
            ...
            if(currentOpcode == 36)
            {
                ...
                if(anInt1149 == 1)
                    anInt883 = incommingVector.readUShortBE();
                if(anInt1149 >= 2 && anInt1149 <= 6)
                {
                    ...
                    anInt1149 = 2;
                    anInt1133 = incommingVector.readUShortBE();
                    anInt1134 = incommingVector.readUShortBE();
                    anInt1135 = incommingVector.readUByte();
                }
                if(anInt1149 == 10)
                    anInt1017 = incommingVector.readUShortBE();
                currentOpcode = -1;
                return true;
            }
            if(currentOpcode == 107)
            {
                int l1 = incommingVector.readUShortLE();
            ...
            if(currentOpcode == 34)
            {
                int j2 = incommingVector.readUShortLE();
                RSInterface.getInterface(j2).anInt636 = 3;
                if(myPlayer.aNpcConfig_1756 == null)
                    ...
                    RSInterface.getInterface(j2).anInt637 = (int)(0x12345678L + myPlayer.aNpcConfig_1756.aLong780);
                currentOpcode = -1;
                return true;
            }
            ...
            if(currentOpcode == 52)
            {
                ...
                for(int k2 = 0; k2 < anInt1168; k2++)
                    aLongArray879[k2] = incommingVector.readLongBE();
            ...
            {
                int l2 = incommingVector.readUShortBE();
                int i12 = incommingVector.readUShortBE();
                int i18 = l2 >> 10 & 0x1f;
                int l22 = l2 >> 5 & 0x1f;
                int j26 = l2 & 0x1f;
             ...
             */
            if(currentOpcode == 31) {
                String s1 = incommingVector.readString();
            ...
            if(currentOpcode == 4)
            {
                int l3 = incommingVector.readUShortBE();
                if(l3 == 65535)
                    l3 = -1;
            ...
            {
                int i4 = incommingVector.readUMediumBE();
                int i13 = incommingVector.readUShortBE();
            ...
            if(currentOpcode == 97)
            {
                long l4 = incommingVector.readLongBE();
            ...
            {
                int j6 = incommingVector.readUShortBE();
                int l13 = incommingVector.readUByte();
                int k19 = incommingVector.readUShortBE();
                if(k19 == 65535) {
                    if(anInt979 < 50) {
            ...
            if(currentOpcode == 58)
            {
                ...
                anInt1298 = incommingVector.readUShortBE();
            ...
            {
                int l6 = incommingVector.readUShortBE();
                method143(l6, 1);
                if(anInt1208 != -1)
                {
                    method15((byte)6, anInt1208);
            ...
            if(currentOpcode == 239) {
                int position = incommingVector.readUShortBE();
                String message = incommingVector.readString();
            ...
            {
                int l7 = incommingVector.readUShortLE();
                method143(l7, 1);
                if(anInt951 != -1)
                {
                    method15((byte)6, anInt951);
            ...
            if(currentOpcode == 179)
            {
                ...
                for(int l14 = 0; l14 < aNpcArray899.length; l14++)
                    if(aNpcArray899[l14] != null)
                        aNpcArray899[l14].anInt1615 = -1;
            ...
            {
                int j8 = incommingVector.readUShortLE();
                int i15 = incommingVector.readIntLE();
            ...
            if(currentOpcode == 24)
            {
                long l8 = incommingVector.readLongBE();
            ...
            if(currentOpcode == 96) {
                needDrawTabArea = true;
                int i9 = incommingVector.readUShortBE();
                RSInterface class34_2 = RSInterface.getInterface(i9);
                while(incommingVector.position < opcodeSize) {
                    int k20 = incommingVector.readUSmart();
                    int j24 = incommingVector.readUShortBE();
            ...
            {
                int j9 = incommingVector.readUShortLE();
                int j15 = incommingVector.readUShortBE();
                int i21 = incommingVector.readUShortLE();
                if(j9 == 65535) {
    ...
    public void parseTrackedNpcUpdateMasks(Buffer buffer, byte byte0)
    {
        if(byte0 != 5)
            return;
        for(int j = 0; j < anInt876; j++)
        {
            ...
            if((l & 4) != 0)
            {
                npc.aNpcConfig_1772 = NpcConfig.getDefinition(buffer.readUShortLE());
                npc.anInt1608 = npc.aNpcConfig_1772.aByte820;
                npc.anInt1609 = npc.aNpcConfig_1772.anInt803;
                npc.anInt1644 = npc.aNpcConfig_1772.anInt813;
                npc.anInt1645 = npc.aNpcConfig_1772.anInt787;
            ...
            if((l & 0x80) != 0)
            {
                npc.anInt1620 = buffer.readUShortBE();
                if(npc.anInt1620 == 65535)
                    npc.anInt1620 = -1;
            }
            if((l & 8) != 0)
            {
            ...
            if((l & 1) != 0)
            {
                npc.aString1605 = buffer.readString();
                npc.anInt1628 = 100;
            }
            if((l & 2) != 0)
            {
    ...
    public void method43(byte byte0)
    {
        ...
        for(int i = 0; i < anInt900; i++)
        {
            ...
            Npc npc = aNpcArray899[j];
            if(npc != null)
                method44(npc.aNpcConfig_1772.aByte820, npc, 9);
        }
    ...
    public void method53(byte byte0)
    {
        try
        {
            ...
            if(!aBoolean1102)
            {
                ...
                if(anInt894 > 155)
                {
                    ...
                    outgoingVector.writeMiddleBE(0x132620);
                }
                outgoingVector.writeOpcode(30);
        ...
        if(super.aFrame_Sub1_18 != null)
        {
            ...
            outgoingVector.writeIntBE(0x3f008edd);
        }
            ...
            if(anIntArray847[j] <= 0)
            {
                ...
                try
                {
                    ...
                    } else
                    {
                        ...
                        if(System.currentTimeMillis() + (long)(class39_sub3_sub3.position / 22) > aLong976 + (long)(anInt1310 / 22))
                        {
                            anInt1310 = class39_sub3_sub3.position;
                            aLong976 = System.currentTimeMillis();
                            if(method80(class39_sub3_sub3.position, true, class39_sub3_sub3.payload))
                            {
                ...
                catch(Exception exception)
                {
                    if(Signlink.reporterror)
                    {
                        ...
                        outgoingVector.writeShortBE(anIntArray1199[j] & 0x7fff);
                    } else
                    {
                        outgoingVector.writeOpcode(142);
                        outgoingVector.writeShortBE(-1);
                    }
                }
    ...
    public void updateNpcs(int j, Buffer buffer)
    {
        ...
        parseTrackedNpcUpdateMasks(buffer, (byte)5);
        for(int k = 0; k < anInt917; k++)
        {
            int l = anIntArray918[k];
            if(aNpcArray899[l].anInt1648 != loopCycle)
            {
                aNpcArray899[l].aNpcConfig_1772 = null;
                aNpcArray899[l] = null;
            }
        }
        ...
        {
            Signlink.reporterror(enteredUsername + " size mismatch in getnpcpos - pos:" + buffer.position + " psize:" + j);
            throw new RuntimeException("eek");
        }
        for(int i1 = 0; i1 < anInt900; i1++)
            if(aNpcArray899[anIntArray901[i1]] == null)
            {
    ...
    public void method83(int i)
    {
        ...
        while(i >= 0) 
            method6();
        NpcConfig.aClass35_816.method363();
    ...
    public void method85(boolean flag, int i)
    {
        ...
        {
            Npc npc = aNpcArray899[anIntArray901[j]];
    ...
    public void method95(byte byte0)
    {
        ...
        {
            Npc npc = aNpcArray899[anIntArray901[i6]];
            if(npc != null && npc.method415(true))
            {
                NpcConfig npcConfig = npc.aNpcConfig_1772;
                if(npcConfig.anIntArray785 != null)
        ...
        {
            if(anInt1149 == 1 && anInt883 >= 0 && anInt883 < aNpcArray899.length)
            {
    ...
    public void method103(Buffer class39_sub3_sub3, boolean flag, int i)
    {
        ...
        if(i == 100)
        {
            ...
            int l18 = class39_sub3_sub3.readUShortBE();
            int k19 = class39_sub3_sub3.readUShortBE();
        ...
        if(i == 69)
        {
            ...
            int j9 = class39_sub3_sub3.readUShortBE();
        ...
        if(i == 194)
        {
            ...
            int i10 = class39_sub3_sub3.readUShortBE();
            int k12 = class39_sub3_sub3.readUShortBE();
            int i15 = class39_sub3_sub3.readUShortBE();
        ...
        if(i == 137)
        {
            ...
            int j10 = class39_sub3_sub3.readUShortBE();
            int l12 = class39_sub3_sub3.readUByte();
            int j15 = class39_sub3_sub3.readUShortBE();
    ...
    public void updatePlayers(int blockSize, Buffer buffer) {
        ...
        if(buffer.position != blockSize) {
            Signlink.reporterror("Error packet size mismatch in getplayer pos:" + buffer.position + " psize:" + blockSize);
            throw new RuntimeException("eek");
        }
    ...
    public void method112(int i, int j)
    {
        ...
        if(i1 == 144)
        {
            ...
            if(npc != null)
            {
                ...
                if(anInt1171 >= 106)
                {
                    ...
                    outgoingVector.writeShortBE(55586);
                    anInt1171 = 0;
                }
        ...
        if(i1 == 1219)
        {
            Npc npc_6 = aNpcArray899[j1];
            if(npc_6 != null)
            {
                NpcConfig npcConfig = npc_6.aNpcConfig_1772;
                if(npcConfig.anIntArray785 != null)
                    npcConfig = npcConfig.method593(0);
                if(npcConfig != null)
                {
                    String s8;
                    if(npcConfig.aByteArray789 != null)
                        s8 = new String(npcConfig.aByteArray789);
                    else
                        s8 = "It's a " + npcConfig.aString821 + ".";
        ...
        if(i1 == 769)
        {
            ...
            if(anInt1164 >= 97)
            {
                ...
                outgoingVector.writeShortBE(43274);
                anInt1164 = 0;
            }
            method124(l, j1, k, -41819);
        ...
        if(i1 == 283)
        {
            ...
            if(player_6 != null)
            {
                ...
                if(anInt1002 >= 88)
                {
                    ...
                    outgoingVector.writeShortBE(5996);
                    anInt1002 = 0;
                }
        ...
        if(i1 == 688)
        {
            ...
            if(anInt1236 >= 119)
            {
                ...
                outgoingVector.writeShortBE(11544);
                anInt1236 = 0;
            }
            ...
            if(l2 != -1)
            {
                ...
                for(int k3 = 0; k3 < playerCount; k3++)
                {
                    ...
                    if(i1 == 119)
                    {
                        ...
                        outgoingVector.writeOpcode(99);
                        outgoingVector.writeShortBE(playerIndices[k3]);
                    }
                    if(i1 == 875)
                    {
                        outgoingVector.writeOpcode(75);
                        outgoingVector.writeShortLE(playerIndices[k3]);
                    }
                    flag8 = true;
                    break;
                }
    ...
    public void method113(int i)
    {
        ...
        synchronized(aClass8_1151.anObject158)
        {
            if(aBoolean1230)
            {
                if(super.anInt29 != 0 || aClass8_1151.anInt157 >= 40)
                {
                    ...
                    {
                        if(k2 - outgoingVector.position >= 240)
                            break;
                        k3++;
                        ...
                        } else
                        {
                            ...
                            if(anInt856 < 8 && k6 >= -32 && k6 <= 31 && l6 >= -32 && l6 <= 31)
                            {
                                k6 += 32;
                                l6 += 32;
                                outgoingVector.writeShortBE((anInt856 << 12) + (k6 << 6) + l6);
                                anInt856 = 0;
                            } else
                            if(anInt856 < 8)
                            {
                                outgoingVector.writeMiddleBE(0x800000 + (anInt856 << 19) + j6);
                                anInt856 = 0;
                            } else
                            {
                                outgoingVector.writeIntBE(0xc0000000 + (anInt856 << 19) + j6);
                                anInt856 = 0;
                            }
                        }
                    }

                    outgoingVector.writeSizeByte(outgoingVector.position - k2);
        ...
        try
        {
            if(socket != null && outgoingVector.position > 0)
            {
                socket.queueBytes((byte)68, 0, outgoingVector.position, outgoingVector.payload);
    ...
    public void login(String username, String password, boolean reconnecting) {
        ...
        try {
            ...
            if(loginResponse == 0) {
                ...
                outgoingVector.writeIntBE(isaacSeed[3]);
                outgoingVector.writeIntBE(Signlink.uid);
                outgoingVector.writeString(username);
                ...
                loginBlock.writeBytes(outgoingVector.payload, 0, outgoingVector.position);
                outgoingVector.isaacCipher = new ISAACCipher(isaacSeed, 0);
                for(int j2 = 0; j2 < 4; j2++) {
                	isaacSeed[j2] += 50;
                }
                decrypter = new ISAACCipher(isaacSeed, 0);
                socket.queueBytes((byte)68, 0, loginBlock.position, loginBlock.payload);
    ...
    public void method129(int i, int j, NpcConfig npcConfig, int k, int l)
    {
        opcodeSize += i;
        if(anInt903 >= 400)
            return;
        ...
        if(npcConfig == null)
            return;
        if(!npcConfig.aBoolean786)
            return;
        String s = npcConfig.aString821;
        if(npcConfig.anInt805 != 0)
            s = s + method118(32572, myPlayer.anInt1768, npcConfig.anInt805) + " (level-" + npcConfig.anInt805 + ")";
        if(anInt905 == 1)
        {
        ...
        {
            if(npcConfig.aStringArray790 != null)
            {
                for(int i1 = 4; i1 >= 0; i1--)
                    if(npcConfig.aStringArray790[i1] != null && !npcConfig.aStringArray790[i1].equalsIgnoreCase("attack"))
                    {
                        aStringArray965[anInt903] = npcConfig.aStringArray790[i1] + " @yel@" + s;
                        if(i1 == 0)
            ...
            if(npcConfig.aStringArray790 != null)
            {
                for(int j1 = 4; j1 >= 0; j1--)
                    if(npcConfig.aStringArray790[j1] != null && npcConfig.aStringArray790[j1].equalsIgnoreCase("attack"))
                    {
                        char c = '\0';
                        if(npcConfig.anInt805 > myPlayer.anInt1768)
                            c = '\u07D0';
                        aStringArray965[anInt903] = npcConfig.aStringArray790[j1] + " @yel@" + s;
                        if(j1 == 0)
    ...
    public void method132(int i)
    {
        ...
        for(int j = -1; j < playerCount + anInt900; j++)
        {
            ...
            if(j < playerCount)
                ...
                obj = aNpcArray899[anIntArray901[j - playerCount]];
            if(obj == null || !((Class39_Sub3_Sub2_Sub5) (obj)).method415(true))
                continue;
            if(obj instanceof Npc)
            {
                NpcConfig npcConfig = ((Npc)obj).aNpcConfig_1772;
                if(npcConfig.anIntArray785 != null)
                    npcConfig = npcConfig.method593(0);
                if(npcConfig == null)
                    continue;
            ...
            {
                NpcConfig npcConfig_1 = ((Npc)obj).aNpcConfig_1772;
                if(npcConfig_1.anInt799 >= 0 && npcConfig_1.anInt799 < aClass39_Sub3_Sub4_Sub4Array1130.length)
                {
                    method108(0, ((Class39_Sub3_Sub2_Sub5) (obj)), ((Class39_Sub3_Sub2_Sub5) (obj)).anInt1606 + 15);
                    if(anInt934 > -1)
                        aClass39_Sub3_Sub4_Sub4Array1130[npcConfig_1.anInt799].method530(anInt934 - 12, 22912, anInt935 - 30);
                }
    ...
    public void method137(int i)
    {
        ...
        for(int k = 0; k < Class39_Sub3_Sub2_Sub4.anInt1586; k++)
        {
            ...
            if(k1 == 1)
            {
                ...
                method129(0, l1, npc.aNpcConfig_1772, j1, i1);
            }
            if(k1 == 0)
            {
            ...
            if(anInt1169 == 2)
            {
                ...
                if(j == 13 || j == 10)
                {
                    if(aString958.length() > 0)
                    {
                        ...
                        outgoingVector.writeLongBE(Class37.stringToLong(aString958));
                    }
                    anInt1169 = 0;
                    aBoolean993 = true;
                }
    ...
    public Class10 method151(int i, String s, int j, String s1, byte byte0, int k)
    {
        ...
        while(abyte0 == null) 
        {
            ...
            try
            {
                ...
                int i2 = class39_sub3_sub3.readMediumBE() + 6;
                int j2 = 6;
                abyte0 = new byte[i2];
    ...
    public Game()
    {
        ...
        anInt1153 = -135;
        aBoolean1156 = false;
        incommingVector = Buffer.allocate(1);
        anInt1160 = -1;
        anInt1161 = -1;
        aBoolean1162 = false;
        aBoolean1163 = false;
        ...
        aBoolean1286 = true;
        aBoolean1287 = true;
        outgoingVector = Buffer.allocate(1);
        tabId = 3;
        aByte1291 = 4;
        aBoolean1293 = false;
        aByte1294 = 0;

...
public class Signlink implements Runnable {
    ...
    {
        String as[] = {
            "./cache/", "c:/windows/", "c:/winnt/", "d:/windows/", "d:/winnt/", "e:/windows/", "e:/winnt/", "f:/windows/", "f:/winnt/", "c:/", "~/", 
    ...
    public static void reporterror(String s) {
        ...
        try {
            ...
            s = s.replace('&', '_');
            s = s.replace('#', '_');
            DataInputStream datainputstream = openurl("reporterror" + 357 + ".cgi?error=" + errorname + " " + s);
